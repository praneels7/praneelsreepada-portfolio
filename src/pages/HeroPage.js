  ...
  const suggestions = [
    {
      ...
      subtitle: "AI, full-stack, and systems work",
    },
    {
      to: "/experience",
      icon: (
      ...
      subtitle: "Snowflake, KTP, and more",
    },
    {
      to: "/contact",
      icon: (
      ...
      title: "Let's connect",
      subtitle: "Say Hello or collaborate",
    },
  ];
    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden px-6 py-24">
      ...
      <div className="relative z-10 max-w-6xl w-full">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">Software Developer Intern &bull; ET Custom Apps</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">Developer &bull; Project Lead &bull; Former Director</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <img src="/fiji_logo.jpg" alt="Phi Gamma Delta" className="w-7 h-7 object-contain rounded" />
                <div>
                  <p className="text-white font-semibold text-sm">Phi Gamma Delta (FIJI)</p>
                  <p className="text-gray-400 text-xs">Vice President &bull; Treasurer</p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 animate-fade-in-up delay-700">
          <p className="text-xs text-gray-500 uppercase tracking-wider mb-4 font-mono">Explore next</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {suggestions.map((s) => (
              <Link key={s.to} to={s.to} className="explore-card">
                ...
                <svg className="w-4 h-4 text-gray-600 arrow relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
